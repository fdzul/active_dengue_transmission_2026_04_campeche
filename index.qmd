---
title: "Programa de Prevención y Control de Arbovirosis | 2026 | 04 Campeche"
format: 
  dashboard:
...
```{r distribucion_campeche,echo=FALSE}
z |>
...
```{r distribucion_carmen,echo=FALSE}
z |>
    dplyr::filter(IDE_EDA_ANO <= 12 | IDE_EDA_ANO >= 65) |>
    dplyr::mutate(onset = FEC_INI_SIGNOS_SINT) |>
    dplyr::select(ANO, long, lat, onset) |>
